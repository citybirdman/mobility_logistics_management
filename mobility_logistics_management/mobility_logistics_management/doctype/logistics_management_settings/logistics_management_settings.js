...
frappe.ui.form.on("Logistics Management Settings", {
	update_shipping_info_now: async function(frm) {
        frappe.dom.freeze();
        await frappe.call({method: "mobility_logistics_management.mobility_logistics_management.shipping_report_data.Update_shipping_report_data.update_shipping_info_now"})
